...
export default function CandidateHomePage({ jobs = [] }: any) {
  ...
  return (
    <div className="h-screen flex flex-col bg-gray-200">
      {/* Header */}
      <div className="p-4 border-b bg-background flex flex-col items-center gap-3">
        ...
        <p className="text-white">See the latest job here</p>
        <div className="w-full text-black p-2 max-w-lg rounded-lg bg-white shadow-sm">
              <SearchBar />
            </div>
      </div>
      ...
      {/* ========================= DESKTOP ========================= */}
      <div className="hidden md:flex flex-1 overflow-hidden pt-6 px-4 gap-4">
        {/* LEFT SIDE */}
